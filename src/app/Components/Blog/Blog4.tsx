...
const Blog4 = () => {
    ...
    const blogContent = [
        ...
        {img:'public/assets/images/pages/blog/moca_fx-410x320.jpg', title:'Harmonização Orofacial em Goiânia: O Guia Definitivo para um Rosto em Equilíbrio', content:'O que é Harmonização Orofacial? Descubra como tratar linhas de expressão, usar preenchimentos e bioestimuladores para alcançar resultados naturais e elevar sua autoestima. Agende sua avaliação em Goiânia.', date: '20/02/2025', url: '/blog/guia-harmonizacao'},
